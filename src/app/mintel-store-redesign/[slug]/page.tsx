  ...
  return (
    <>
      <div className="relative min-h-[70vh] overflow-hidden flex items-center justify-center -mt-24 md:-mt-32 pt-24 md:pt-32">
        ...
        <Link href="/mintel-store-redesign" className="absolute z-20 left-8 top-36 md:top-44 lg:top-28 text-sm font-extralight text-white/80 hover:text-white transition-colors">
          ← Collections
        </Link>
