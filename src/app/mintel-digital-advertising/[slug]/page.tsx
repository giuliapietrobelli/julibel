  ...
  return (
    <>
      <div className="relative min-h-[70vh] overflow-hidden flex items-center justify-center -mt-24 md:-mt-32 pt-24 md:pt-32">
        ...
        <Link href="/mintel-digital-advertising" className="absolute z-20 left-8 top-36 md:top-44 lg:top-28 text-sm font-extralight text-white/80 hover:text-white transition-colors">
          ← Collections
        </Link>
        ...
        <div className="relative z-10 flex flex-col items-center gap-8 text-white text-center px-8 max-w-2xl py-16 md:py-20">
          ...
          <p className="font-extralight text-sm md:text-base leading-loose opacity-90">
            Part of the Soft Tide collection — calm coastal patterns in muted blues, sandy neutrals and organic shapes inspired by the sea.
          </p>
          <div className="flex flex-wrap gap-4 justify-center">
            <Link
              href="https://www.spoonflower.com/collections/1483469-soft-tide-by-julibel_studio"
              target="_blank"
      ...
      <PaginationLinks
        prev={prev ? prev.title : 'Soft Tide'}
        prevLink={prev ? `/mintel-digital-advertising/${prev.slug}` : '/mintel-digital-advertising'}
        next={next ? next.title : 'Soft Tide'}
        nextLink={next ? `/mintel-digital-advertising/${next.slug}` : '/mintel-digital-advertising'}
      />
    </>
  )
}
