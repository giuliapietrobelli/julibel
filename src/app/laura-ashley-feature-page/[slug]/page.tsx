  ...
  return (
    <>
      ...
      <PaginationLinks
        ...
        prevLink={prev ? `/laura-ashley-feature-page/${prev.slug}` : '/laura-ashley-feature-page'}
        next={next ? next.title : 'Echoes of Siam'}
        nextLink={next ? `/laura-ashley-feature-page/${next.slug}` : '/laura-ashley-feature-page'}
      />
    </>
  )
}
