  ...
  return (
    <>
      <div className="relative min-h-[70vh] overflow-hidden flex items-center justify-center -mt-24 lg:-mt-32 pt-24 lg:pt-32">
        ...
        <Link href="/playful-cats" className="absolute z-20 left-8 top-36 md:top-44 lg:top-28 text-sm font-extralight text-white/80 hover:text-white transition-colors">
          ← Collections
        </Link>
      ...
      <PaginationLinks
        ...
        prevLink={prev ? `/playful-cats/${prev.slug}` : '/playful-cats'}
        next={next ? next.title : 'Playful Cats'}
        nextLink={next ? `/playful-cats/${next.slug}` : '/playful-cats'}
      />
    </>
  )
}
