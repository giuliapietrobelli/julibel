  ...
  return (
    <>
      <div className="relative min-h-[70vh] overflow-hidden flex items-center justify-center -mt-24 md:-mt-32 pt-24 md:pt-32">
        ...
        <Link href="/echoes-of-siam" className="absolute z-20 left-8 top-36 md:top-44 lg:top-28 text-sm font-extralight text-white/80 hover:text-white transition-colors">
          ← Collections
        </Link>
        ...
        <div className="animate-fade-up relative z-10 flex flex-col items-center gap-8 text-white text-center px-8 max-w-2xl py-16 md:py-20">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Link
              href="https://www.spoonflower.com/collections/1360307-echoes-siam-by-julibel"
              target="_blank"
      ...
      <PaginationLinks
        prev={prev ? prev.title : 'Echoes of Siam'}
        prevLink={prev ? `/echoes-of-siam/${prev.slug}` : '/echoes-of-siam'}
        next={next ? next.title : 'Echoes of Siam'}
        nextLink={next ? `/echoes-of-siam/${next.slug}` : '/echoes-of-siam'}
      />
    </>
  )
}
