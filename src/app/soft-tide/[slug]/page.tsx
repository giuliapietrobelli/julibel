  ...
  return (
    <>
      <div className="relative min-h-[70vh] overflow-hidden flex items-center justify-center -mt-24 lg:-mt-32 pt-24 lg:pt-32">
        ...
        <Link href="/soft-tide" className="absolute z-20 left-8 top-36 md:top-44 lg:top-28 text-sm font-extralight text-white/80 hover:text-white transition-colors">
          ← Collections
        </Link>
      ...
      <PaginationLinks
        ...
        prevLink={prev ? `/soft-tide/${prev.slug}` : '/soft-tide'}
        next={next ? next.title : 'Soft Tide'}
        nextLink={next ? `/soft-tide/${next.slug}` : '/soft-tide'}
      />
    </>
  )
}
