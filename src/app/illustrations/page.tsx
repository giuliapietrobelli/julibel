    ...
    <>
      ...
      <div className="container flex flex-col gap-10 md:gap-20 pt-8 pb-20">
        ...
        <div className="flex flex-col items-center gap-8 text-center max-w-3xl xl:max-w-4xl self-center py-6">
          <h2 className="font-normal md:font-medium text-2xl md:text-3xl lg:text-4xl leading-snug">Collection 4</h2>
          <p className="font-extralight text-lg lg:text-xl leading-relaxed">A selection of illustrations made with Procreate, Illustrator, and Photoshop</p>
