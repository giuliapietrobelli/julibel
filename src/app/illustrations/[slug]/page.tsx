  ...
  return (
    <>
      <div className="relative min-h-[70vh] overflow-hidden flex items-center justify-center -mt-24 md:-mt-32 pt-24 md:pt-32">
        ...
        <Link href="/illustrations" className="absolute z-20 left-8 top-36 md:top-44 lg:top-28 text-sm font-extralight text-white/80 hover:text-white transition-colors">
          ← Collections
        </Link>
        ...
        <div className="relative z-10 flex flex-col items-center gap-8 text-white text-center px-8 max-w-2xl py-16 md:py-20">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Link
              href="https://www.spoonflower.com/collections/1357811-playful-cats-by-julibel"
              target="_blank"
      ...
      <PaginationLinks
        prev={prev ? prev.title : 'Playful Cats'}
        prevLink={prev ? `/illustrations/${prev.slug}` : '/illustrations'}
        next={next ? next.title : 'Playful Cats'}
        nextLink={next ? `/illustrations/${next.slug}` : '/illustrations'}
      />
    </>
  )
}
