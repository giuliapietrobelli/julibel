...
export default function HeroCarousel() {
  ...
  return (
    <section
      className="w-full flex flex-col lg:flex-row overflow-hidden lg:min-h-[400px] -mt-24 md:-mt-32 lg:-mt-52"
      onMouseEnter={() => setPaused(true)}
      onMouseLeave={() => setPaused(false)}
    >
      {/* ── LEFT TEXT PANEL ── */}
      <div
        className="order-2 lg:order-1 relative flex flex-col lg:w-[40%] w-full flex-shrink-0 px-10 md:px-12 xl:px-14 pt-14 pb-20 lg:pt-[17rem] lg:pb-24 min-h-[360px] lg:min-h-0"
