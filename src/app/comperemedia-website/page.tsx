    ...
    <>
      ...
      <div className="container flex flex-col gap-10 md:gap-20 pt-8 pb-20">
        <div className="flex flex-col items-center gap-8 text-center max-w-3xl xl:max-w-4xl self-center py-6">
          <h2 className="font-normal md:font-medium text-2xl md:text-3xl lg:text-4xl leading-snug">Collection 2</h2>
          <p className="font-extralight text-lg lg:text-xl leading-relaxed">At Mintel, I collaborated on the design of the marketing website for Comperemedia. Working closely with the marketing team designers, I was responsible for finalizing the design and ensuring a smooth handoff to the developers.</p>
